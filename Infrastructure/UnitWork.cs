...
namespace yuyu.Infrastructure
{
    ...
    {
       private yuyuDBContext _context;

       public UnitWork(yuyuDBContext context)
       {
           _context = context;
       }
       public yuyuDBContext GetDbContext()
       {
           return _context;
       }
        ...
        public void BatchUpdate<T>(T[] entities) where T : class
        {
